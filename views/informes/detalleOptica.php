...
<body>
	...
	<div class="" >
		...
		<div class="card" style="margin-top: 120px;margin-left: 200px;margin-right: 200px;">
			<div class="card-body">
					...
					<table id="tblDocumentos" class="table mx-auto">
						...
						<tbody>
							<?php
								...
								// echo "Fecha y hora actual: $fechaHora_actual<br>";
							...
							<td style="display:none;"><?php echo $row["id"]; ?></td>
								...
								<!-- Accion que determina el estado de la tencion en linea dinamicamente. -->
								<!-- Definiendo los siguientes colores: -->
								<!--Rojo = pacientes que no sistieron. 
									verde = pacientes que sistieron.
