			...
			<div class="card-body">
				<form class="row" id="form-buscar" action="<?php echo constant('URL'); ?>informe/verPaginacion_Detalle_Pacientes/1" method="POST">
					<div class="position-relative mb-4">
                            <h3>
							<div class="alert alert-primary text-center">Detalle Agenda Pacientes</div>
						</h3>
					...
					<!-- <div class="form-group col-md-3 d-flex align-items-end">
						<input type="date" class="form-control form-control-sm me-2" name="fecha_desde" id="fecha_desde" placeholder="Fecha desde">
					</div>

					<div class="form-group col-md-3 d-flex align-items-end">
						<input type="date" class="form-control form-control-sm me-2" name="fecha_hasta" id="fecha_hasta" placeholder="Fecha hasta">
					</div> -->
				...
				success: function(response) {
					...
					if (response.tension.length > 0){
						...
						for (let i = 0; i < response.tension.length; i++){
							...
							// let anio = fecha.getFullYear();
							let partes = fecha_atencion.split('-'); // Divide la fecha en partes [YYYY, MM, DD]
							let anio = partes[0];
							let mes = partes[1];
							let dia = partes[2];
