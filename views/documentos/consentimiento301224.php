...
<body>
			...
			<div class="card-body">
				<form class="row" id="form-buscar" action="<?php echo constant('URL'); ?>consentimiento/verPaginacion_consentimiento/1" method="POST">
					<div class="position-relative mb-4">
						<h3>
							<div class="alert alert-primary text-center">Documentos</div>
						</h3>
					</div>
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td class="rut_medico" style="display:none;"><?php echo $row["med_rut"]; ?></td>
									...
									<!-- <td style="text-align: center;"><?php //echo $row["rut_pnatural"]; 
																			?></td> -->
									<td class="rut_paciente" style="text-align: center;"><?php echo $row["rut_completo"]; ?></td>
									<td class="nombres_paciente" style="text-align: center;"><?php echo $row["nombres"] . ' ' . $row["apellido_paterno"] . ' ' . $row["apellido_materno"]; ?></td>
	...
	<script>
		...
		function ver_documento(tipoDoc, rut, nombrePaciente, fecha_atencion, centro, email, telefono, hora_atencion, rut_medico, nombre_medico){
			...
			const url = "<?php echo constant('URL') ?>consentimiento/"+metodo;
		...
		$(document).ready(function() {
			...
			$('#tblDocumentos').on('click', '.descarga', function(e) {
				...
				ver_documento(tipoDocumento, rut, nombrePaciente, fecha_atencion, centro, email, telefono, hora_atencion, rut_medico, nombre_medico);
