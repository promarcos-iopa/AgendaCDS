...
<body>
	...
	<div class="container">
		...
		<div class="card">
			<div class="card-body">
				<form class="row" id="form-imprimir" action="<?php echo constant('URL'); ?>consentimiento/procesar_imprimir_todos" method="POST">
    ...
    <script>
        $(document).ready(function () {
            $('#btnImprimir').on('click', function (e) {
                ...
                const baseUrl = "<?php echo constant('URL'); ?>consentimiento/procesar_imprimir_todos";
