                        ...
                        <?php
                            ...
                            foreach ($this->usuariosperfil as $row) {
                                ...
                                if ($usuariosperfil->principal == "Documentos") {
                                    ...
                                    <?php } elseif ($usuariosperfil->menu == "docTodos") { ?>
                                        <li>
                                            <a class="dropdown-item" href="<?php echo constant('URL'); ?><?php echo 'consentimiento'; ?>/ver_imprimir_todos">
                                                <?php echo 'Imprimir Todos'; ?>
                                            </a>
                                        </li>
