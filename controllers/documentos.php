...
class Documentos extends Controller
{
    ...
    function verPaginacion_doc_pacientes($param = null)
    {
        ...
        /*fin*/
        $this->view->render('documentos/doc_pacientes');
    }
    ...
    function ver_ges_pdf($param = null){
        ...
        $nombre_medico = isset($_GET['nombre_medico']) ? $_GET['nombre_medico'] : '';
        $direccion = isset($_GET['direccion']) ? $_GET['direccion'] : '';
        $comuna = isset($_GET['comuna']) ? $_GET['comuna'] : '';
        $region = isset($_GET['region']) ? $_GET['region'] : '';
        $nombre_social_paciente = isset($_GET['nombre_social_paciente']) ? $_GET['nombre_social_paciente'] : '';

        $nombre_social_paciente=trim($nombre_social_paciente);
        if(is_null($nombre_social_paciente) OR $nombre_social_paciente=="")
        {
            $nombre_social_paciente=$nombrePaciente;
            // echo "asfasdasdasd";
        }
        // echo $nombre_social_paciente;
        // return;
        ...
        $this->view->comuna =$comuna;
        $this->view->region =$region;
        $this->view->nombre_social_paciente =$nombre_social_paciente;
    ...
    //* Agregado el 27-12-2024
    function mostrar_todos_pdf($param = null){
